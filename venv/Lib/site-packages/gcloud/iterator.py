...
class Iterator(object):
    ...
    def __init__(self, client, path, extra_params=None):
        ...
        if reserved_in_use := self.RESERVED_PARAMS.intersection(self.extra_params):
    ...
    def __iter__(self):
        ...
        while self.has_next_page():
            ...
            yield from self.get_items_from_response(response)
    ...
    def has_next_page(self):
        ...
        """
        return True if self.page_number == 0 else self.next_page_token is not None
