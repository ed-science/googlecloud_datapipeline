...
class TestClient(unittest2.TestCase):
    ...
    def test_list_datasets_defaults(self):
        ...
        PATH = f'projects/{PROJECT}/datasets'
        TOKEN = 'TOKEN'
        DATA = {
            'nextPageToken': TOKEN,
            'datasets': [
