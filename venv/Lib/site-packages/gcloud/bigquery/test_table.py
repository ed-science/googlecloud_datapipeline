...
class TestTable(unittest2.TestCase, _SchemaBase):
    ...
    def _setUpConstants(self):
        ...
        self.WHEN = datetime.datetime.utcfromtimestamp(self.WHEN_TS).replace(
            tzinfo=UTC)
        self.ETAG = 'ETAG'
        self.TABLE_ID = f'{self.PROJECT}:{self.DS_NAME}:{self.TABLE_NAME}'
    ...
    def test_ctor(self):
        ...
        self.assertEqual(
            table.path,
            f'/projects/{self.PROJECT}/datasets/{self.DS_NAME}/tables/{self.TABLE_NAME}',
        )
    ...
    def test_props_set_by_server(self):
        ...
        TABLE_ID = f'{self.PROJECT}:{self.DS_NAME}:{self.TABLE_NAME}'
        URL = f'http://example.com/projects/{self.PROJECT}/datasets/{self.DS_NAME}/tables/{self.TABLE_NAME}'
    ...
    def test_from_api_repr_bare(self):
        ...
        dataset = _Dataset(client)
        RESOURCE = {
            'id': f'{self.PROJECT}:{self.DS_NAME}:{self.TABLE_NAME}',
            'tableReference': {
                'projectId': self.PROJECT,
                'datasetId': self.DS_NAME,
                'tableId': self.TABLE_NAME,
    ...
    def test_create_w_bound_client(self):
        from gcloud.bigquery.table import SchemaField
        PATH = f'projects/{self.PROJECT}/datasets/{self.DS_NAME}/tables'
        RESOURCE = self._makeResource()
        ...
        self.assertEqual(req['path'], f'/{PATH}')
        SENT = {
            'tableReference': {
                'projectId': self.PROJECT,
                'datasetId': self.DS_NAME,
    ...
    def test_exists_miss_w_bound_client(self):
        PATH = f'projects/{self.PROJECT}/datasets/{self.DS_NAME}/tables/{self.TABLE_NAME}'
    ...
    def test_fetch_data_w_bound_client(self):
        ...
        PATH = f'projects/{self.PROJECT}/datasets/{self.DS_NAME}/tables/{self.TABLE_NAME}/data'
    ...
    def test_insert_data_w_bound_client(self):
        ...
        WHEN = datetime.datetime.utcfromtimestamp(WHEN_TS).replace(
            tzinfo=UTC)
        PATH = f'projects/{self.PROJECT}/datasets/{self.DS_NAME}/tables/{self.TABLE_NAME}/insertAll'
    ...
    def _upload_from_file_helper(self, **kw):
        ...
        with _NamedTemporaryFile() as temp:
            ...
            with open(temp.name, 'rb') as file_obj:
                BODY = file_obj.read()
                if explicit_size := kw.pop('_explicit_size', False):
                    kw['size'] = len(BODY)
...
class _Dataset(object):
    ...
    @property
    def path(self):
        return f'/projects/{self._client.project}/datasets/{self.name}'
