...
class TestDataset(unittest2.TestCase):
    ...
    def _setUpConstants(self):
        ...
        self.WHEN = datetime.datetime.utcfromtimestamp(self.WHEN_TS).replace(
            tzinfo=UTC)
        self.ETAG = 'ETAG'
        self.DS_ID = f'{self.PROJECT}:{self.DS_NAME}'
    ...
    def test_ctor(self):
        ...
        self.assertEqual(
            dataset.path, f'/projects/{self.PROJECT}/datasets/{self.DS_NAME}'
        )
    ...
    def test_from_api_repr_bare(self):
        ...
        client = _Client(self.PROJECT)
        RESOURCE = {
            'id': f'{self.PROJECT}:{self.DS_NAME}',
            'datasetReference': {
    ...
    def test_create_w_bound_client(self):
        PATH = f'projects/{self.PROJECT}/datasets'
        RESOURCE = self._makeResource()
    ...
    def test_exists_miss_w_bound_client(self):
        PATH = f'projects/{self.PROJECT}/datasets/{self.DS_NAME}'
        conn = _Connection()
        client = _Client(project=self.PROJECT, connection=conn)
        dataset = self._makeOne(self.DS_NAME, client=client)
    ...
    def test_list_tables_defaults(self):
        ...
        DATA = {
            ...
            'tables': [
                {
                    'kind': 'bigquery#table',
                    'id': f'{self.PROJECT}:{self.DS_NAME}.{TABLE_1}',
                    'tableReference': {
                        'tableId': TABLE_1,
                        'datasetId': self.DS_NAME,
                        'projectId': self.PROJECT,
                ...
                {
                    'kind': 'bigquery#table',
                    'id': f'{self.PROJECT}:{self.DS_NAME}.{TABLE_2}',
                    'tableReference': {
                        'tableId': TABLE_2,
                        'datasetId': self.DS_NAME,
                        'projectId': self.PROJECT,
