...
class UDFResourcesProperty(object):
    ...
    def __get__(self, instance, owner):
        ...
        return self if instance is None else list(instance._udf_resources)
...
class _AsyncJob(_BaseJob):
    ...
    def path(self):
        ...
        """
        return f'/projects/{self.project}/jobs/{self.name}'
    ...
    def _get_resource_config(cls, resource):
        ...
        return name, resource['configuration'][cls._JOB_TYPE]
    ...
    def cancel(self, client=None):
        ...
        api_response = client.connection.api_request(
            method='POST', path=f'{self.path}/cancel'
        )
