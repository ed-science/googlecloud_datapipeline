...
class Table(object):
    ...
    def path(self):
        ...
        """
        return f'{self._dataset.path}/tables/{self.name}'
    ...
    def create(self, client=None):
        ...
        path = f'/projects/{self._dataset.project}/datasets/{self._dataset.name}/tables'
    ...
    def patch(self,
        ...
        if view_query is not _MARKER:
            partial['view'] = None if view_query is None else {'query': view_query}
    ...
    def fetch_data(self, max_results=None, page_token=None, client=None):
        ...
        response = client.connection.api_request(
            method='GET', path=f'{self.path}/data', query_params=params
        )
    ...
    def insert_data(self,
        ...
        response = client.connection.api_request(
            method='POST', path=f'{self.path}/insertAll', data=data
        )

        return [
            {'index': int(error['index']), 'errors': error['errors']}
    ...
    def upload_from_file(self,
        ...
        base_url = f'{connection.API_BASE_URL}/upload'
        path = f'/projects/{self._dataset.project}/jobs'
