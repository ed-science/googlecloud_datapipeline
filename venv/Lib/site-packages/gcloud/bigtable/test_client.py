...
class TestClient(unittest2.TestCase):
    ...
    def test_list_instances(self):
        ...
        LOCATION = f'projects/{self.PROJECT}/locations/locname'
        FAILED_LOCATION = 'FAILED'
        INSTANCE_ID1 = 'instance-id1'
        INSTANCE_ID2 = 'instance-id2'
        INSTANCE_NAME1 = f'projects/{self.PROJECT}/instances/{INSTANCE_ID1}'
        INSTANCE_NAME2 = f'projects/{self.PROJECT}/instances/{INSTANCE_ID2}'
...
class Test_MetadataPlugin(unittest2.TestCase):
    ...
    def test___call__(self):
        ...
        cb_headers = [
            ('Authorization', f'Bearer {access_token_expected}'),
