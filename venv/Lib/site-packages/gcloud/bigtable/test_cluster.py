...
class TestOperation(unittest2.TestCase):
    ...
    def _finished_helper(self, done):
        ...
        # Create request_pb
        op_name = (
            f'operations/projects/{PROJECT}/instances/{INSTANCE_ID}/clusters/{CLUSTER_ID}'
            + '/operations/%d' % (OP_ID,)
        )
...
class Test__parse_pb_any_to_native(unittest2.TestCase):
    ...
    def test_with_known_type_url(self):
        ...
        type_url = f'type.googleapis.com/{cell.DESCRIPTOR.full_name}'
...
class _Instance(object):
    ...
    @property
    def name(self):
        return f'projects/{self._client.project}/instances/{self.instance_id}'
