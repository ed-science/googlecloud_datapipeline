...
class Table(object):
    ...
    * :meth:`list_column_families` in the table
    ...
    def name(self):
        ...
        """
        return f'{self._instance.name}/tables/{self.table_id}'
    ...
    def __eq__(self, other):
        return (
            (other.table_id == self.table_id and other._instance == self._instance)
    ...
    def read_row(self, row_key, filter_=None):
        ...
        return None if len(rows_data.rows) == 0 else rows_data.rows[row_key]
    ...
    def sample_row_keys(self):
        ...
        client = self._instance._client
        return client._data_stub.SampleRowKeys(request_pb, client.timeout_seconds)
