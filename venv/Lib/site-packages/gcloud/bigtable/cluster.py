...
def _process_operation(operation_pb):
    ...
    if match is None:
        raise ValueError('Operation name was not in the expected '
                         ...
                         operation_pb.name)
    return int(match.group('operation_id'))
...
class Operation(object):
    ...
    def __eq__(self, other):
        return (
            (
                ...
                and other._cluster == self._cluster
    ...
    def finished(self):
        ...
        operation_name = f'operations/{self._cluster.name}' + '/operations/%d' % (
            self.op_id,
        )
...
class Cluster(object):
    ...
    * :meth:`undelete` itself
    ...
    def name(self):
        ...
        """
        return f'{self._instance.name}/clusters/{self.cluster_id}'
