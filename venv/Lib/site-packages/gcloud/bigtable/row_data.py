...
class PartialRowData(object):
    ...
    def __eq__(self, other):
        return (
            (other._row_key == self._row_key and other._cells == self._cells)
            if isinstance(other, self.__class__)
            else False
        )
...
class PartialRowsData(object):
    ...
    def __eq__(self, other):
        return (
            other._response_iterator == self._response_iterator
            if isinstance(other, self.__class__)
            else False
        )
    ...
    def state(self):
        ...
        return self.NEW_ROW if self._previous_cell is None else self.ROW_IN_PROGRESS
    ...
    def consume_next(self):
        ...
        if self._last_scanned_row_key is None and response.last_scanned_row_key:
